...
\section{Prototipi}
Partendo dagli esempi della design library, grazie ai risultati ottenuti dalle interviste e dopo aver identificato quali siano le problematiche che ostacolano maggiormente la partecipazione, abbiamo deciso di porre particolare attenzione alla gestione delle labels su Github, partendo dalla gestione che abbiamo potuto osservare all'interno del progetto di NeoVim.\\
