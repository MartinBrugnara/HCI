...
\vfill
Tutto il materiale ed i sorgenti di questo progetto si possono trovare su \center\textbf{\url{https://github.com/MartinBrugnara/HCI}}.
\newpage
...
%				far vedere ciclo (re)design - evaluation
%				valutazione del prototipo finale (autocritica + intervista a Fabio)
%				dove avremmo potuto fare meglio
%				abbiamo sacrificato leggermente l'intuitività della label per benefici a "lungo termine"
%				link ai prototipi interattivi su github
%
%-------------------------------------------------------------------------------------------------------------------------------